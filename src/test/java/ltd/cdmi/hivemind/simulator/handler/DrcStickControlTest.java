 ...
 * stick_control 无回包机制，杆量值域 [-65536, 65536]，5-10Hz 连续下发。
 */
class DrcStickControlTest {
    ...
    void pitchFullStick_movesNorthAndTiltsNoseDown() {
        ...
        handler.integrateStick(SECOND_NANOS, 0, 65536, 0, 0);
        ...
        handler.integrateStick(SECOND_NANOS + HALF_NANOS, 0, 65536, 0, 0);
    ...
    void throttleFullStick_climbsHeightAndElevation() {
        ...
        handler.integrateStick(SECOND_NANOS, 0, 0, 0, 0);                       // 建立基准
        handler.integrateStick(SECOND_NANOS + SECOND_NANOS / 2, 0, 0, 65536, 0); // dt=0.5s 满杆上升
    ...
    void yawFullStick_rotatesHeadingAndShiftsMovementDirection() {
        ...
        handler.integrateStick(SECOND_NANOS, 0, 0, 0, 65536);            // 建立基准 + 满杆顺时针
        handler.integrateStick(SECOND_NANOS + HALF_NANOS, 0, 0, 0, 65536); // dt=0.5s：60°/s → heading 0→30
        ...
        handler.integrateStick(SECOND_NANOS + HALF_NANOS * 2, 0, 65536, 0, 0);
    ...
    void stickIgnored_whenDroneInDock() {
        ...
        handler.integrateStick(SECOND_NANOS, 65536, 65536, 65536, 65536);
        handler.integrateStick(SECOND_NANOS * 2, 65536, 65536, 65536, 65536);
    ...
    void dtCapped_afterStickStreamGap() {
        ...
        handler.integrateStick(SECOND_NANOS, 0, 65536, 0, 0);                    // 建立基准
        handler.integrateStick(SECOND_NANOS * 6, 0, 65536, 0, 0);                // 间隔 5s
    ...
    void stickControlRoutesToIntegration() throws Exception {
        ...
        invokeHandleDrcCommand(handler,
                "{\"method\":\"stick_control\",\"data\":{\"roll\":0,\"pitch\":65536,\"throttle\":0,\"yaw\":0},\"seq\":100}");
