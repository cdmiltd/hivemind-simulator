...
class SimulatorPowerStateTest {
    ...
    /** 构造 Controller：除 DeviceState（被测状态载体）外全部 mock */
    private SimulatorController newController(DeviceState state) {
        ...
        return new SimulatorController(
                ...
                state, mock(MqttClientManager.class), mock(WaylineTaskSimulator.class),
