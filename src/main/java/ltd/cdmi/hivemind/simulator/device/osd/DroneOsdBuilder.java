 ...
 * <p>与 {@link DockOsdBuilder}（机场字段集）平行，各管一方。
 * 所有机型统一使用 snake_case 字段命名，顶层字段名引用 {@link ltd.cdmi.dji.cloudapi.sdk.telemetry.OsdField} 枚举。</p>
...
public interface DroneOsdBuilder {
     ...
     * <p>用于日志和调试，不参与 Builder 选择（选择基于 {@link #supports(DroneModel)}）。</p>
     */
     ...
     */
    boolean supports(DroneModel droneType);
