 ...
 * <p>payload_index 差异由 {@link DefaultCameraResolver#defaultCameraFor(DroneModel)} 自动处理（M3D→80-0-0，M4D→98-0-0）。</p>
...
public class M3DDroneOsdBuilder extends M4DDroneOsdBuilder {
    ...
    public boolean supports(DroneModel droneType) {
        return droneType == DroneModel.M3D || droneType == DroneModel.M3TD;
    }
}
