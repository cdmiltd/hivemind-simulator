 ...
 * <p>Pilot 遥控器 OSD 使用 snake_case 命名风格（与所有 Dock 版本一致）。
...
public interface RcOsdBuilder {
     ...
     * <p>用于 {@link DeviceSimulator} 按遥控器类型选择 Builder。</p>
     */
    default boolean supports(RcModel controllerType) {
        return false;
    }
     ...
     */
    Map<String, Object> buildRcOsd(OsdContext ctx);
}
