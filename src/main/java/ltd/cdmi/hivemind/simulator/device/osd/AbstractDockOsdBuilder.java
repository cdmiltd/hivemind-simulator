...
public abstract class AbstractDockOsdBuilder implements DockOsdBuilder {
    ...
    public final List<Map<String, Object>> buildDockOsd(OsdContext ctx) {
        ...
        positionAndEnv.put(OsdField.LATITUDE.fieldName(), ctx.getRuntimeConfig().getLocationLatitude());
        positionAndEnv.put(OsdField.LONGITUDE.fieldName(), ctx.getRuntimeConfig().getLocationLongitude());
        positionAndEnv.put(OsdField.HEIGHT.fieldName(), ctx.getRuntimeConfig().getLocationHeight());
