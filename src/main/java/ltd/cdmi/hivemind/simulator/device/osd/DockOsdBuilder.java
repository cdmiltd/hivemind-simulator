 ...
 * <p>所有 Dock 版本统一使用 snake_case 字段命名，顶层字段名引用 {@link ltd.cdmi.dji.cloudapi.sdk.telemetry.OsdField} 枚举。</p>
...
public interface DockOsdBuilder {
    ...
    /**
     * 协议版本标识。
     * <p>用于 OSD payload 的 version 字段。Dock1/Dock2 共用 "dock1"，Dock3 用 "dock3"。</p>
     */
    String version();

    /**
     * 判断此 Builder 是否支持指定的机场类型。
     * <p>用于 {@link DeviceSimulator} 按 dockType 选择 Builder。</p>
     */
    default boolean supports(DockModel dockType) {
        return false;
    }
     ...
     * @return 多条 OSD data 字段内容，字段名使用 snake_case
     */
