...
public enum DeviceType {
    // 机场 (domain=3)
    DOCK1(3, 1, 0, "大疆机场", "Dock1"),
    DOCK2(3, 2, 0, "大疆机场2", "Dock2"),
    DOCK3(3, 3, 0, "大疆机场3", "Dock3"),

    // 飞行器 (domain=0)
    M30 (0, 67,  0, "Matrice 30",  "M30"),
    M30T(0, 67,  1, "Matrice 30T", "M30T"),
    M3D (0, 91,  0, "Matrice 3D",  "M3D"),
    M3TD(0, 91,  1, "Matrice 3TD", "M3TD"),
    M4D (0, 100, 0, "Matrice 4D",  "M4D"),
    M4TD(0, 100, 1, "Matrice 4TD", "M4TD");
    ...
    DeviceType(int domain, int type, int subType, String displayName, String shortName) {
        this.domain = domain;
        this.type = type;
